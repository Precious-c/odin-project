...
var Book = require('./models/item')
var Author = require('./models/category')
...
function itemCreate(itemName, itemDescription, price, numberInStock, itemCategory, URL, cb) {
  itemDetail = {itemName:itemName , itemDescription: itemDescription }
